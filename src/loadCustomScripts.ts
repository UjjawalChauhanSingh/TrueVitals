...
var v = {
    ...
    SELECTED_ATTR: "data-app-selected",
    HOVERED_ATTR: "data-app-hovered",
    OVERRIDE_STYLESHEET_ID: "custom-override"
}
  , _ = e => {
  ...
  , et = () => new Promise(e => {
    ...
    new MutationObserver( (n, o) => {
        ...
        i && i.children.length > 0 && (o.disconnect(),
        e())
    }
...
var fr = () => {
    ...
    window.fetch = async function(...t) {
        ...
        try {
            ...
            if (t?.[1]?.body)
                try {
                    typeof t[1].body == "string" ? n = t[1].body : t[1].body instanceof FormData ? n = "FormData: " + Array.from(t[1].body.entries()).map( ([i,l]) => `${i}=${l}`).join("&") : t[1].body instanceof URLSearchParams ? n = t[1].body.toString() : n = JSON.stringify(t[1].body)
                } catch {
            ...
            if (t?.[1]?.body)
                try {
                    typeof t[1].body == "string" ? o = t[1].body : t[1].body instanceof FormData ? o = "FormData: " + Array.from(t[1].body.entries()).map( ([a,s]) => `${a}=${s}`).join("&") : t[1].body instanceof URLSearchParams ? o = t[1].body.toString() : o = JSON.stringify(t[1].body)
                } catch {
  ...
  , St = ( () => {
    ...
    return () => {
        ...
        ;
        fr();
        let o = l => r.has(l) ? !0 : (r.add(l),
        setTimeout( () => r.delete(l), 5e3),
        !1)
          , i = l => {
            let a = n(l);
            if (o(a))
...
function ae(e, t={}, r=new WeakMap, n="root") {
    ...
    if (e === void 0)
        return new U("undefined","undefined");
    if (e === null)
        return null;
    if (typeof e == "string")
        return e.length > o.maxStringLength ? new U("String",`${e.slice(0, o.maxStringLength)}... [${e.length - o.maxStringLength} more characters]`) : e;
    if (typeof e == "number")
        return Number.isNaN(e) ? new U("Number","NaN") : Number.isFinite(e) ? e : new U("Number",e > 0 ? "Infinity" : "-Infinity");
    if (typeof e == "boolean")
        return e;
    if (typeof e == "bigint")
        return new U("BigInt",e.toString());
    if (typeof e == "symbol")
        return new U("Symbol",e.toString());
    ...
    if (e instanceof Promise)
        return new U("Promise","[Promise]");
    if (e instanceof WeakMap || e instanceof WeakSet)
        return new U(e.constructor.name,"[" + e.constructor.name + "]");
    if (e instanceof Set) {
        let s = Array.from(e);
        return s.length > o.maxArrayLength ? new U("Set",{
            values: s.slice(0, o.maxArrayLength).map( (c, d) => ae(c, o, r, `${n}.Set[${d}]`)),
    ...
    if (Array.isArray(e))
        return e.length > o.maxArrayLength ? e.slice(0, o.maxArrayLength).map( (s, c) => ae(s, o, r, `${n}[${c}]`)).concat([`... ${e.length - o.maxArrayLength} more items`]) : e.map( (s, c) => ae(s, o, r, `${n}[${c}]`));
    let i = {}
      , l = [...Object.getOwnPropertyNames(e)];
    o.includeSymbols && l.push(...Object.getOwnPropertySymbols(e).map(s => s.toString()));
    let a = 0;
    return l.slice(0, o.maxObjectKeys).forEach(s => {
        try {
            let c = e[s];
            i[s] = ae(c, o, r, `${n}.${s}`)
        } catch (c) {
    ...
    l.length > o.maxObjectKeys && (a = l.length - o.maxObjectKeys,
    i["..."] = `${a} more properties`),
    i
}
var hr = {
  ...
  , bt = ( () => {
    ...
    return () => {
        ...
        let i = l => {
            console[l] = (...a) => {
                hr[l].apply(console, a);
                let s = null;
                if (l === "warn" || l === "error") {
                    let m = new Error;
                    m.stack && (s = m.stack.split(`
`).slice(2).join(`
`))
                }
                let c = a.map(m => ae(m, {
                  ...
                  , d = c.map(m => typeof m == "string" ? m : JSON.stringify(m, null, 2).slice(0, 1e4)).join(" ") + (s ? `
` + s : "")
                  , u = {
                    level: gr[l],
...
function ke(e) {
    var t = e.maskInputOptions
      ...
      , i = e.maskInputFn
      , l = o || "";
    return (t[r.toLowerCase()] || t[n]) && (i ? l = i(l) : l = "*".repeat(l.length)),
    l
}
...
var Se, Tt, wr = /url\((?:(')([^']*)'|(")(.*?)"|([^)]*))\)/gm, kr = /^(?!www\.|(?:http|ftp)s?:\/\/|[A-Za-z]:\\|\/\/|#).*/, Lr = /^(data:)([^,]*),(.*)/i;
function xe(e, t) {
    return (e || "").replace(wr, function(r, n, o, i, l, a) {
        ...
        if (s[0] === "/")
            return "url(".concat(c).concat(Tr(t) + s).concat(c, ")");
        var d = t.split("/")
          , u = s.split("/");
        d.pop();
...
function Mr(e, t) {
    ...
    !(r >= t.length); ) {
        var i = n(Nr);
        if (i.slice(-1) === ",")
            i = be(e, i.substring(0, i.length - 1)),
            o.push(i);
        else {
            var l = "";
            i = be(e, i);
...
function st(e, t, r, n) {
    return r === "src" || r === "href" && n && !(t === "use" && n[0] === "#") || r === "xlink:href" && n && n[0] !== "#" || r === "background" && n && (t === "table" || t === "td" || t === "th") ? be(e, n) : r === "srcset" && n ? Mr(e, n) : r === "style" && n ? xe(n, it()) : t === "object" && r === "data" && n ? be(e, n) : n
}
function xr(e, t, r) {
    if (typeof t == "string") {
...
function Br(e, t) {
    var r, n = t.maskTextClass, o = t.maskTextSelector, i = t.maskTextFn, l = t.rootId, a = e.parentNode && e.parentNode.tagName, s = e.textContent, c = a === "STYLE" ? !0 : void 0, d = a === "SCRIPT" ? !0 : void 0;
    if (c && s) {
        try {
...
function Gr(e, t) {
    for (var r = t.doc, n = t.blockClass, o = t.blockSelector, i = t.inlineStylesheet, l = t.maskInputOptions, a = l === void 0 ? {} : l, s = t.maskInputFn, c = t.dataURLOptions, d = c === void 0 ? {} : c, u = t.inlineImages, m = t.recordCanvas, h = t.keepIframeSrcFn, p = t.newlyAddedElement, S = p === void 0 ? !1 : p, b = t.rootId, A = xr(e, n, o), g = Ar(e), y = {}, R = e.attributes.length, P = 0; P < R; P++) {
    ...
    if (g === "input" || g === "textarea" || g === "select") {
        var M = e.value
          , I = e.checked;
        y.type !== "radio" && y.type !== "checkbox" && y.type !== "submit" && y.type !== "button" && M ? y.value = ke({
            type: y.type,
            tagName: g,
            value: M,
            maskInputOptions: a,
    ...
    if (g === "option" && (e.selected && !a.select ? y.selected = !0 : delete y.selected),
    g === "canvas" && m) {
        if (e.__context === "2d")
    ...
    if ((g === "audio" || g === "video") && (y.rr_mediaState = e.paused ? "paused" : "played",
    y.rr_mediaCurrentTime = e.currentTime),
    S || (e.scrollLeft && (y.rr_scrollLeft = e.scrollLeft),
    ...
    return g === "iframe" && !h(y.src) && (e.contentDocument || (y.rr_src = y.src),
    delete y.src),
    {
        type: Z.Element,
        tagName: g,
...
function Ur(e, t) {
    ...
    if (e.type === Z.Element) {
        if (t.script && (e.tagName === "script" || e.tagName === "link" && e.attributes.rel === "preload" && e.attributes.as === "script" || e.tagName === "link" && e.attributes.rel === "prefetch" && typeof e.attributes.href == "string" && e.attributes.href.endsWith(".js")))
            return !0;
        if (t.headFavicon && (e.tagName === "link" && e.attributes.rel === "shortcut icon" || e.tagName === "meta" && (x(e.attributes.name).match(/^msapplication-tile(image|color)$/) || x(e.attributes.name) === "application-name" || x(e.attributes.rel) === "icon" || x(e.attributes.rel) === "apple-touch-icon" || x(e.attributes.rel) === "shortcut icon")))
            return !0;
        if (e.tagName === "meta") {
            if (t.headMetaDescKeywords && x(e.attributes.name).match(/^description|keywords$/))
                return !0;
            if (t.headMetaSocial && (x(e.attributes.property).match(/^(og|twitter|fb):/) || x(e.attributes.name).match(/^(og|twitter):/) || x(e.attributes.name) === "pinterest"))
                return !0;
...
function pe(e, t) {
    ...
    if ((G.type === Z.Document || G.type === Z.Element) && re) {
        ...
        if (yr(e) && e.shadowRoot)
            for (var ee = 0, O = Array.from(e.shadowRoot.childNodes); ee < O.length; ee++) {
                var Q = O[ee]
                  , F = pe(Q, Ce);
                F && (me(e.shadowRoot) && (F.isShadow = !0),
                G.childNodes.push(F))
            }
    }
    return e.parentNode && ge(e.parentNode) && me(e.parentNode) && (G.isShadow = !0),
    G.type === Z.Element && G.tagName === "iframe" && Dr(e, function() {
    ...
    G.type === Z.Element && G.tagName === "link" && G.attributes.rel === "stylesheet" && Fr(e, function() {
        if (k) {
            var j = pe(e, {
                doc: r,
                mirror: n,
...
typeof window < "u" && window.Proxy && window.Reflect && (Nt = new Proxy(Nt,{
    get(e, t, r) {
        return t === "map" && console.error(ve),
        Reflect.get(e, t, r)
    }
}));
function Ae(e, t, r={}) {
    ...
    return function(...i) {
        ...
        n = null),
        o = l,
        e.apply(s, i)) : !n && r.trailing !== !1 && (n = setTimeout( () => {
            o = r.leading === !1 ? 0 : Date.now(),
            n = null,
            e.apply(s, i)
        }
        , a))
...
;
var L = (e => (e[e.DomContentLoaded = 0] = "DomContentLoaded",
e[e.Load = 1] = "Load",
...
var dt = class {
    ...
    addNode(t) {
        ...
        if (t.__ln = r,
        t.previousSibling && Ot(t.previousSibling)) {
    ...
    removeNode(t) {
        let r = t.__ln;
        this.head && (r.previous ? (r.previous.next = r.next,
        r.next && (r.next.previous = r.previous)) : (this.head = r.next,
    ...
    constructor() {
        ...
        this.emit = () => {
              ...
              , o = a => {
                ...
                let A = pe(a, {
                    ...
                    onSerialize: g => {
                        ...
                        Ge(g, this.mirror) && this.stylesheetManager.trackLinkElement(g),
                        Ue(a) && this.shadowDomManager.addShadowRoot(a.shadowRoot, this.doc)
                    }
                    ,
                    onIframeLoad: (g, y) => {
            ...
            for (let a of Array.from(this.movedSet.values()))
                Dt(this.removes, a, this.mirror) && !this.movedSet.has(a.parentNode) || o(a);
            for (let a of Array.from(this.addedSet.values()))
                !Ft(this.droppedSet, a) && !Dt(this.removes, a, this.mirror) || Ft(this.movedSet, a) ? o(a) : this.droppedSet.add(a);
            let i = null;
            for (; r.length; ) {
                let a = null;
                if (i) {
                ...
                case "characterData":
                    {
                        ...
                        !W(t.target, this.blockClass, this.blockSelector, !1) && r !== t.oldValue && this.texts.push({
                            value: at(t.target, this.maskTextClass, this.maskTextSelector) && r ? this.maskTextFn ? this.maskTextFn(r) : r.replace(/[\S]/g, "*") : r,
                            node: t.target
                        });
                        break
                    }
                case "attributes":
                    {
                        ...
                        t.attributeName === "style") {
                            ...
                            o.attributes[t.attributeName] = st(this.doc, r.tagName, t.attributeName, n);
                        break
                    }
                case "childList":
                    {
                        ...
                        t.removedNodes.forEach(r => {
                            ...
                            W(t.target, this.blockClass, this.blockSelector, !1) || We(r, this.mirror) || !Rt(r, this.mirror) || (this.addedSet.has(r) ? (ut(this.addedSet, r),
                            this.droppedSet.add(r)) : this.addedSet.has(t.target) && n === -1 || lt(t.target, this.mirror) || (this.movedSet.has(r) && this.movedMap[xt(n, o)] ? ut(this.movedSet, r) : this.removes.push({
                                parentId: o,
                                id: n,
                                isShadow: ge(t.target) && me(t.target) ? !0 : void 0
                            })),
        ...
        this.genAdds = (t, r) => {
            if (this.mirror.hasNode(t)) {
                ...
                n && n !== -1 && (this.movedMap[xt(this.mirror.getId(t), n)] = !0)
            } else
                this.addedSet.add(t),
...
function Vr({mousemoveCb: e, sampling: t, doc: r, mirror: n}) {
    if (t.mousemove === !1)
        return () => {}
        ;
    let o = typeof t.mousemove == "number" ? t.mousemove : 50, i = typeof t.mousemoveCallback == "number" ? t.mousemoveCallback : 500, l = [], a, s = Ae(u => {
        let m = Date.now() - a;
        e(l.map(h => (h.timeOffset -= m,
        h)), u),
        l = [],
        a = null
    }
    , i), c = Ae(u => {
        ...
        s(typeof DragEvent < "u" && u instanceof DragEvent ? w.Drag : u instanceof MouseEvent ? w.MouseMove : w.TouchMove)
    }
    , o, {
        trailing: !1
...
function Pr({mouseInteractionCb: e, doc: t, mirror: r, blockClass: n, blockSelector: o, sampling: i}) {
    ...
    ;
    return Object.keys(He).filter(c => Number.isNaN(Number(c)) && !c.endsWith("_Departed") && l[c] !== !1).forEach(c => {
        let d = c.toLowerCase()
          , u = s(c);
        a.push(K(d, u, t))
    }
...
function Bt(e, t) {
    ...
    return t || delete r.userTriggered,
    r
}
...
function zr({inputCb: e, doc: t, mirror: r, blockClass: n, blockSelector: o, ignoreClass: i, maskInputOptions: l, maskInputFn: a, sampling: s, userTriggeredOnInput: c}) {
    function d(A) {
        ...
        !g || !g.tagName || Kr.indexOf(g.tagName) < 0 || W(g, n, o, !0))
            return;
        let R = g.type;
        if (g.classList.contains(i))
            return;
        let P = g.value
          , H = !1;
        R === "radio" || R === "checkbox" ? H = g.checked : (l[g.tagName.toLowerCase()] || l[R]) && (P = ke({
            maskInputOptions: l,
            tagName: g.tagName,
            type: R,
            value: P,
        ...
        let f = g.name;
        R === "radio" && f && H && t.querySelectorAll(`input[type="radio"][name="${f}"]`).forEach(C => {
            C !== g && u(C, Bt({
                text: C.value,
                isChecked: !H,
                userTriggered: !1
    ...
    function u(A, g) {
        ...
        if (!y || y.text !== g.text || y.isChecked !== g.isChecked) {
            Gt.set(A, g);
            let R = r.getId(A);
            e(Object.assign(Object.assign({}, g), {
                id: R
            }))
        }
    }
    ...
    return S && S.set && h.push(...b.map(A => ye(A[0], A[1], {
        set() {
            d({
                target: this
            })
...
function Yr({styleSheetRuleCb: e, mirror: t, stylesheetManager: r}, {win: n}) {
    ...
    ;
    let l;
    n.CSSStyleSheet.prototype.replace && (l = n.CSSStyleSheet.prototype.replace,
    ...
    let a;
    n.CSSStyleSheet.prototype.replaceSync && (a = n.CSSStyleSheet.prototype.replaceSync,
    ...
    let s = {};
    Ut ? s.CSSGroupingRule = n.CSSGroupingRule : (Ht && (s.CSSMediaRule = n.CSSMediaRule),
...
function Zt(e, t={}) {
    ...
    let n = ft(e, e.doc)
      ...
      , p = qr(e)
      , S = [];
    for (let b of e.plugins)
        S.push(b.observer(b.callback, r, b.options));
    return () => {
...
var Ne = class {
    ...
    getIdToRemoteIdMap(t) {
        ...
        return r || (r = new Map,
        this.iframeIdToRemoteIdMap.set(t, r)),
        r
    }
    getRemoteIdToIdMap(t) {
        let r = this.iframeRemoteIdToIdMap.get(t);
        return r || (r = new Map,
        this.iframeRemoteIdToIdMap.set(t, r)),
        r
    }
}
;
var Ze = class {
    ...
    transformCrossOriginEvent(t, r) {
        ...
        switch (r.type) {
        case L.FullSnapshot:
            return this.crossOriginIframeMirror.reset(t),
        ...
        case L.Plugin:
            return r;
        case L.Custom:
            return this.replaceIds(r.data.payload, t, ["id", "parentId", "previousId", "nextId"]),
            r;
        case L.IncrementalSnapshot:
            ...
            case w.AdoptedStyleSheet:
                ...
                (n = r.data.styles) === null || n === void 0 || n.forEach(o => {
    ...
    replaceIdOnNode(t, r) {
        ...
        "childNodes"in t && t.childNodes.forEach(n => {
...
var Ke = class {
    constructor(t) {
        ...
        this.mirror = t.mirror;
        let r = this;
        this.restorePatches.push(ne(Element.prototype, "attachShadow", function(n) {
            return function(o) {
                let i = n.call(this, o);
                return this.shadowRoot && r.addShadowRoot(this.shadowRoot, this.ownerDocument),
                i
            }
        }))
    }
    addShadowRoot(t, r) {
        ...
        ft(Object.assign(Object.assign({}, this.bypassOptions), {
            doc: r,
            mutationCb: this.mutationCb,
            mirror: this.mirror,
            shadowDomManager: this
        }), t),
        pt(Object.assign(Object.assign({}, this.bypassOptions), {
    ...
    observeAttachShadow(t) {
        if (t.contentWindow) {
            let r = this;
            this.restorePatches.push(ne(t.contentWindow.HTMLElement.prototype, "attachShadow", function(n) {
                return function(o) {
                    let i = n.call(this, o);
                    return this.shadowRoot && r.addShadowRoot(this.shadowRoot, t.contentDocument),
                    i
                }
            }))
        }
...
var Ye = (e, t, r) => [...e].map(n => ze(n, t, r))
  , Qt = (e, t) => !!["WebGLActiveInfo", "WebGLBuffer", "WebGLFramebuffer", "WebGLProgram", "WebGLRenderbuffer", "WebGLShader", "WebGLShaderPrecisionFormat", "WebGLTexture", "WebGLUniformLocation", "WebGLVertexArrayObject", "WebGLVertexArrayObjectOES"].filter(o => typeof t[o] == "function").find(o => e instanceof t[o]);
function jt(e, t, r, n) {
    let o = []
    ...
    for (let l of i)
        try {
            ...
            let a = ne(t.CanvasRenderingContext2D.prototype, l, function(s) {
                return function(...c) {
                    return W(this.canvas, r, n, !0) || setTimeout( () => {
                        let d = Ye([...c], t, this);
                        e(this.canvas, {
                            type: ce["2D"],
                            property: l,
...
function gt(e, t, r) {
    ...
    try {
        let o = ne(e.HTMLCanvasElement.prototype, "getContext", function(i) {
            return function(l, ...a) {
                return W(this, t, r, !0) || "__context"in this || (this.__context = l),
                i.apply(this, [l, ...a])
            }
        });
        n.push(o)
...
function Xt(e, t, r, n, o) {
    let i = [];
    return i.push(...qt(t.WebGLRenderingContext.prototype, ce.WebGL, e, r, n, o, t)),
...
var yt = null;
try {
    $t = typeof module < "u" && typeof module.require == "function" && module.require("worker_threads") || typeof __non_webpack_require__ == "function" && __non_webpack_require__("worker_threads") || typeof $e == "function" && $e("worker_threads"),
    yt = $t.Worker
} catch {}
var $t;
function tn(e, t) {
...
`, 10) + 1
    ...
    return function(c) {
        return new yt(a,Object.assign({}, c, {
            eval: !0
        }))
    }
}
...
var or = nr("", null, !1);
var Je = class {
    constructor(t) {
        ...
        l && typeof r == "number" && this.initCanvasFPSObserver(r, n, o, i, {
            dataURLOptions: a
        })
    }
    reset() {
    ...
    initCanvasFPSObserver(t, r, n, o, i) {
        ...
        let c = 1e3 / t, d = 0, u, m = () => {
            let p = [];
            return r.document.querySelectorAll("canvas").forEach(S => {
                W(S, n, o, !0) || p.push(S)
            }
            ),
            p
        ...
        , h = p => {
            ...
            d = p,
            m().forEach(S => zt(this, void 0, void 0, function*() {
                var b;
...
var B, je, It, qe = !1, oe = kt();
function Ie(e={}) {
    let {emit: t, checkoutEveryNms: r, checkoutEveryNth: n, blockClass: o="rr-block", blockSelector: i=null, ignoreClass: l="rr-ignore", maskTextClass: a="rr-mask", maskTextSelector: s=null, inlineStylesheet: c=!0, maskAllInputs: d, maskInputOptions: u, slimDOMOptions: m, maskInputFn: h, maskTextFn: p, hooks: S, packFn: b, sampling: A={}, dataURLOptions: g={}, mousemoveWait: y, recordCanvas: R=!1, recordCrossOriginIframes: P=!1, userTriggeredOnInput: H=!1, collectFonts: f=!1, inlineImages: C=!1, plugins: M, keepIframeSrcFn: I= () => !1, ignoreCSSAttributes: k=new Set([])} = e
    ...
    y !== void 0 && A.mousemove === void 0 && (A.mousemove = y),
    oe.reset();
    let D = d === !0 ? {
        color: !0,
        date: !0,
    ...
    B = (E, z) => {
        var Q;
        if (!((Q = fe[0]) === null || Q === void 0) && Q.isFrozen() && E.type !== L.FullSnapshot && !(E.type === L.IncrementalSnapshot && E.data.source === w.Mutation) && fe.forEach(F => F.unfreeze()),
        T)
            t?.(le(E), z);
        else if (N) {
            let F = {
        ...
        if (E.type === L.FullSnapshot)
            te = E,
            ie = 0;
        else if (E.type === L.IncrementalSnapshot) {
            if (E.data.source === w.Mutation && E.data.isAttachIframe)
                return;
            ie++;
            let F = n && ie >= n
    ...
    je = (E=!1) => {
        ...
        let Te = Lt(document, {
            ...
            ,
            onIframeLoad: (Y, Xe) => {
                se.attachIframe(Y, Xe),
                Ce.observeAttachShadow(Y)
            }
            ,
        ...
        B(V({
            ...
            data: {
                node: Te,
                initialOffset: {
                    left: window.pageXOffset !== void 0 ? window.pageXOffset : document?.documentElement.scrollLeft || ((Q = (z = document?.body) === null || z === void 0 ? void 0 : z.parentElement) === null || Q === void 0 ? void 0 : Q.scrollLeft) || ((F = document?.body) === null || F === void 0 ? void 0 : F.scrollLeft) || 0,
                    top: window.pageYOffset !== void 0 ? window.pageYOffset : document?.documentElement.scrollTop || ((O = (ee = document?.body) === null || ee === void 0 ? void 0 : ee.parentElement) === null || O === void 0 ? void 0 : O.scrollTop) || ((j = document?.body) === null || j === void 0 ? void 0 : j.scrollTop) || 0
                }
            }
        })),
    ...
    try {
        ...
        let z = F => {
            ...
            return Zt({
                ...
                mediaInteractionCb: O => B(V({
                    type: L.IncrementalSnapshot,
                    data: Object.assign({
                        source: w.MediaInteraction
                    }, O)
                })),
                styleSheetRuleCb: O => B(V({
                    type: L.IncrementalSnapshot,
                    data: Object.assign({
                        source: w.StyleSheetRule
                    }, O)
                })),
                styleDeclarationCb: O => B(V({
                    type: L.IncrementalSnapshot,
                    data: Object.assign({
                ...
                plugins: ((ee = M?.filter(O => O.observer)) === null || ee === void 0 ? void 0 : ee.map(O => ({
                    observer: O.observer,
                    options: O.options,
                    callback: j => B(V({
                        type: L.Plugin,
        ...
        ;
        return document.readyState === "interactive" || document.readyState === "complete" ? Q() : E.push(K("load", () => {
            B(V({
                type: L.Load,
                data: {}
            })),
...
var an = e => {
    let t = r => {
        let o = {
            type: "node",
            children: [],
            attrs: [...r.attributes].reduce( (i, l) => (i[l.name] = l.value,
            i), {}),
            tagName: r.tagName,
            data: Oe(r)
        };
...
var Me = e => e.hasAttribute("data-lov-id") || e.hasAttribute("data-component-path")
  ...
  , Oe = e => {
    let t = e.getAttribute("data-lov-id") || ""
      ...
      , a = Array.from(e.children).filter(s => Me(s) && q(s).filePath !== r).filter( (s, c, d) => c === d.findIndex(u => q(u).filePath === q(s).filePath)).map(s => ({
  ...
  , dr = () => {
    ...
    let n = () => {
      ...
      , o = f => {
        if (!(!t.tooltip || !f))
            try {
                ...
                if (t.tooltip.style.maxWidth = `${v.MAX_TOOLTIP_WIDTH}px`,
                I)
                ...
                console.error("Error updating tooltip:", C),
                d()
            }
    }
      , i = f => {
      ...
      , s = r(f => {
        if (!t.isActive || !Me(f.target) || f.target.tagName.toLowerCase() === "html" || a(f.target))
            return;
        t.hoveredElement && b(q(t.hoveredElement)).forEach(I => {
    ...
    , v.DEBOUNCE_DELAY)
      , c = r( () => {
        t.isActive && (t.hoveredElement && ((t.hoveredElement && b(q(t.hoveredElement)))?.forEach(C => {
    ...
    , v.DEBOUNCE_DELAY)
      ...
      , S = () => {
        ...
        t.hoveredElement && (t.hoveredElement.hasAttribute(v.SELECTED_ATTR) || l(t.hoveredElement),
        t.hoveredElement = null),
        d()
    }
      , b = f => {
      ...
      , A = f => {
        try {
            if (!f?.origin || !f?.data?.type || !v.ALLOWED_ORIGINS.includes(f.origin))
                return;
            switch (f.data.type) {
            case "TOGGLE_SELECTOR":
                let C = !!f.data.payload;
                t.isActive !== C && (t.isActive = C,
                t.isActive ? (p(),
                et().then( () => {
                ...
                document.querySelectorAll(`[${v.HOVERED_ATTR}], [data-full-width]`).forEach(k => {
                    k.hasAttribute(v.SELECTED_ATTR) || (l(k),
            ...
            case "UPDATE_SELECTED_ELEMENTS":
                ...
                f.data.payload.forEach(I => {
                    ...
                    b({
                        ...
                        Math.abs(T.getBoundingClientRect().width - window.innerWidth) < 5 && T.setAttribute("data-full-width", "true")
                    }
                    )
                }
                );
            ...
            case "GET_PARENT_ELEMENT":
                {
                    ...
                    !N || N.id === "root" || ["HTML", "BODY"].includes(N.tagName) ? _({
                        type: "PARENT_ELEMENT",
                        payload: null
                    }) : _({
                        type: "PARENT_ELEMENT",
            ...
            console.error("Error handling message:", C),
            S(),
            t.reset()
        }
    }
    ...
    let P = f => {
        if (t.isActive && !(!Me(f.target) || f.target.tagName.toLowerCase() === "html" || a(f.target)) && (f.preventDefault(),
        f.stopPropagation(),
        t.hoveredElement)) {
...
;
var ln = () => {
    if (window.location.search.includes("custom-dev-override")) {
        let t = "http://localhost:8001/custom-runtime.js";
        console.log("Overriding script with:", t);
